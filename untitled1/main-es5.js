...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_mat_header_cell_35_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_mat_cell_36_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_mat_header_cell_38_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 24);
    ...
    function AppComponent_mat_cell_39_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function AppComponent_mat_header_cell_41_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 24);
    ...
    function AppComponent_mat_cell_42_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function AppComponent_mat_header_cell_44_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 24);
    ...
    function AppComponent_mat_cell_45_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function AppComponent_mat_header_cell_47_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell", 24);
    ...
    function AppComponent_mat_cell_48_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
    ...
    function AppComponent_mat_header_row_49_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
      }
    }

    function AppComponent_mat_row_50_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        key: "inputStation",
        value: function inputStation(station) {
        ...
        key: "inputRiver",
        value: function inputRiver(river) {
          this.river = river;
        }
      }, {
        key: "ngOnInit",
        ...
        value: function fillOptions() {
          ...
          this.httpService.get('https://danepubliczne.imgw.pl/api/data/hydro/', {
            ...
            _this.arrRivers = data; // tslint:disable-next-line:prefer-for-of

            for (var i = 0; i < _this.arrRivers.length; i++) {
              // @ts-ignore
              if (!_this.stationOptions.includes(_this.arrRivers[i].stacja)) {
                // @ts-ignore
                _this.stationOptions.push(_this.arrRivers[i].stacja);
              } // @ts-ignore


              if (!_this.stateOptions.includes(_this.arrRivers[i].województwo)) {
                // @ts-ignore
                _this.stateOptions.push(_this.arrRivers[i].województwo);
              } // @ts-ignore


              if (!_this.riverOptions.includes(_this.arrRivers[i].rzeka) && _this.arrRivers[i].województwo === _this.state) {
                console.log(_this.state); // @ts-ignore

                _this.riverOptions.push(_this.arrRivers[i].rzeka);
              }
            }

            _this.stateOptions.sort(function (a, b) {
              return a.localeCompare(b);
            });

            _this.riverOptions.sort(function (a, b) {
              return a.localeCompare(b);
            });
          });
        }
        ...
        key: "subscribeApi",
        value: function subscribeApi() {
          var returnData;
          this.httpService.get('./assets/json/response.json').subscribe(function (data) {
            returnData = data;
            console.log(data);
          });
          return returnData;
        ...
        value: function searchRiver() {
          ...
          this.httpService.get('https://danepubliczne.imgw.pl/api/data/hydro/', {
            ...
            _this2.arrRivers = data;
          }); // tslint:disable-next-line:prefer-for-of

          for (var i = 0; i < this.arrRivers.length; i++) {
            // @ts-ignore
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, "Wybierz wojew\xF3dztwo ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_mat_form_field_click_15_listener() {
            return ctx.fillOptions();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "\u0179r\xF3d\u0142em pochodzenia danych jest Instytut Meteorologii i Gospodarki Wodnej \u2013 Pa\u0144stwowy Instytut Badawczy ");
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_4__["MatFormFieldModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_8__["MatButtonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_9__["MatAutocompleteModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_10__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_11__["MatSortModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_12__["MatToolbarModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_13__["MatTabsModule"], ngx_echarts__WEBPACK_IMPORTED_MODULE_14__["NgxEchartsModule"].forRoot({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _chart_chart_component__WEBPACK_IMPORTED_MODULE_15__["ChartComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_4__["MatFormFieldModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInputModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_8__["MatButtonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_9__["MatAutocompleteModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_10__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_11__["MatSortModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_12__["MatToolbarModule"], _angular_material_tabs__WEBPACK_IMPORTED_MODULE_13__["MatTabsModule"], ngx_echarts__WEBPACK_IMPORTED_MODULE_14__["NgxEchartsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppChartChartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ChartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 2,
      consts: [[1, "river-chart", 3, "initOpts", "options", "chartInit"]],
      template: function ChartComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "echarts", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("chartInit", function ChartComponent_Template_echarts_chartInit_0_listener($event) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Lenovo\Desktop\webdev\RiverStatusPoland\v2\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
